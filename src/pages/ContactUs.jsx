...
const ContactUs = () => {
  ...
  return (
    <section className="relative bg-white">
      <div className="contact-us-container bg-white py-20 px-8 lg:px-24 relative overflow-hidden">
        {/* SVG Shape with Parallax */}
        ...
        {/* Hero Section */}
        <section
          className="hero-section text-center py-10 relative z-10"
          data-aos="fade-up"
          data-aos-delay="100"
        >
        ...
        {/* Contact Information */}
        <section className="contact-info my-16 grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          <div
            className="contact-card p-8 bg-white shadow-lg border border-[#f87709] rounded-lg text-center transition-transform transform hover:-translate-y-2 hover:shadow-lg"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            <FaMapMarkerAlt className="text-[#f87709] text-4xl mx-auto mb-4" />
          ...
          >
            ...
            >
              <FaWhatsapp className="text-6xl text-[#f87709] mx-auto mb-4" />
            </a>
          ...
          <div
            ...
            data-aos-delay="400"
          >
            <FaEnvelope className="text-[#f87709] text-4xl mx-auto mb-4" />
        ...
        {/* Contact Form */}
        <section
          className="contact-form-section border border-[#f87709] bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto relative z-10"
          data-aos="fade-up"
          data-aos-delay="500"
        >
          ...
          >
            <div className="form-group col-span-2">
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full mt-1 p-3 border border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500"
        ...
        <img
          ...
          alt="Egg Omelette"
          className="fixed top-36 right-10 w-1/3 lg:w-1/4 lg:h-auto object-cover opacity-100 pointer-events-none z-1"
          data-aos="fade-up"
          data-aos-delay="600"
        />
      </div>
