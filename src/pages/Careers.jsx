...
const Careers = () => {
  ...
  return (
    <section className="relative bg-white">
      {/* Hero Section */}
      <div className="relative h-[60vh] flex items-center justify-center bg-gradient-to-r from-yellow-300 to-[#f87709] overflow-hidden">
        {/* Egg SVGs */}
        <svg
        ...
        <svg
          className="absolute top-1/4 right-20 w-24 h-24 opacity-40"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
          stroke="white"
      ...
      <section className="py-16 px-6 lg:px-24 bg-white text-center">
        ...
        <p
          className="text-md md:text-lg text-gray-600 mt-6 max-w-3xl mx-auto"
          data-aos="fade-up"
          data-aos-delay="200"
        >
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <svg
              className="w-16 h-16 text-[#f87709] mb-4"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
      ...
      <section className="py-16 bg-[#f87709] text-center text-white">
        <h2 className="text-4xl md:text-5xl font-bold" data-aos="fade-up">
          Apply for Your Dream Job
        </h2>
        <p
          className="text-md md:text-lg mt-4 max-w-3xl mx-auto"
          data-aos="fade-up"
          data-aos-delay="200"
        >
        ...
        <button
          ...
          className="mt-8 px-6 py-3 bg-white text-[#f87709] font-semibold rounded-md hover:bg-gray-200 transition-all"
          data-aos="fade-up"
          data-aos-delay="300"
        >
          Apply Now
      ...
      <section className="py-16 bg-white text-center">
        ...
        <p
          className="text-md md:text-lg text-gray-600 mt-4 max-w-3xl mx-auto"
          data-aos="fade-up"
          data-aos-delay="200"
        >
        ...
        <button
          className="mt-8 px-6 py-3 bg-[#f87709] text-white font-semibold rounded-md hover:bg-[#f76605] transition-all"
          data-aos="fade-up"
          data-aos-delay="300"
        >
          Contact Us
